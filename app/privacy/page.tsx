  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <section className="card space-y-2">
        ...
        <p className="text-sm text-ink-700">
          Вы можете отозвать согласие на обработку данных, потребовать их
          удаления, а также отозвать представительство агентства прямо в
          личном кабинете.
        </p>
      </section>
      ...
      <section className="card space-y-2">
        ...
        <p className="text-sm text-ink-700">
          ...
          мы прекратим обработку и удалим данные по вашему запросу.
        </p>
      </section>
    </div>
  );
