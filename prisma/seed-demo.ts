...
const WORKERS = [
  { email: `w1@${DEMO_DOMAIN}`,  name: "Анна Петрова",      phone: "+7 916 100-01-01", address: "м. Маяковская",    about: "5 лет опыта в гостиницах 4*. Аккуратная, могу выходить в любые смены.",            positions: ["Горничная", "Ресепшн/Администратор"],      minPayment: 4000 },
  { email: `w2@${DEMO_DOMAIN}`,  name: "Михаил Иванов",     phone: "+7 916 100-02-02", address: "м. Курская",       about: "Шеф-повар с опытом 8 лет. Холодный/горячий цех. Готов на разовые смены.",          positions: ["Повар (линейный)", "Менеджер смены"],       minPayment: 5500 },
  { email: `w3@${DEMO_DOMAIN}`,  name: "Елена Соколова",    phone: "+7 916 100-03-03", address: "м. Чистые пруды",  about: "Бариста, обучение SCA. Английский B1. Свободна по утрам.",                          positions: ["Бариста", "Бармен"],                        minPayment: 3800 },
  { email: `w4@${DEMO_DOMAIN}`,  name: "Дмитрий Волков",    phone: "+7 916 100-04-04", address: "м. Парк культуры", about: "Официант 3 года, рестораны a la carte. Беру вечерние смены.",                       positions: ["Официант", "Рунер"],                        minPayment: 3500 },
  { email: `w5@${DEMO_DOMAIN}`,  name: "Ольга Кузнецова",   phone: "+7 916 100-05-05", address: "м. Полянка",       about: "Опыт ресепшн 2 года, английский B2. Готова на ночные смены.",                       positions: ["Хостес", "Ресепшн/Администратор"],          minPayment: 5000 },
  { email: `w6@${DEMO_DOMAIN}`,  name: "Андрей Морозов",    phone: "+7 916 100-06-06", address: "м. Сокол",         about: "Повар горячего цеха, 4 года. Любые смены.",                                         positions: ["Повар (линейный)", "Кухонный работник"],    minPayment: 4500 },
  { email: `w7@${DEMO_DOMAIN}`,  name: "Виктория Новикова", phone: "+7 916 100-07-07", address: "м. Таганская",     about: "Активная, опыт официанта 1 год + бариста 6 мес.",                                   positions: ["Официант", "Бариста"],                      minPayment: 3500 },
  { email: `w8@${DEMO_DOMAIN}`,  name: "Руслан Хайруллин",  phone: "+7 916 100-08-08", address: "м. Марьина Роща",  about: "Бармен 5 лет, классика и авторские коктейли. Есть медкнижка.",                      positions: ["Бармен", "Официант"],                       minPayment: 5000 },
  { email: `w9@${DEMO_DOMAIN}`,  name: "Светлана Гусева",   phone: "+7 916 100-09-09", address: "м. Аэропорт",      about: "Горничная в апарт-отелях, работаю быстро, знаю химию и текстиль.",                  positions: ["Горничная", "Прачечная"],                   minPayment: 3600 },
  { email: `w10@${DEMO_DOMAIN}`, name: "Игорь Савельев",    phone: "+7 916 100-10-10", address: "м. Автозаводская", about: "Универсал: рунер, кухонный работник, разгрузка. Без опыта не боюсь.",               positions: ["Рунер", "Кухонный работник"],               minPayment: 3000 },
  { email: `w11@${DEMO_DOMAIN}`, name: "Алина Егорова",     phone: "+7 916 100-11-11", address: "м. Смоленская",    about: "Хостес в ресторанах премиум-сегмента, английский C1.",                              positions: ["Хостес", "Официант"],                       minPayment: 4200 },
  { email: `w12@${DEMO_DOMAIN}`, name: "Николай Зайцев",    phone: "+7 916 100-12-12", address: "м. Тульская",      about: "Технический сотрудник: сантехника, электрика, мелкий ремонт.",                      positions: ["Технический персонал"],                     minPayment: 4000 },
  { email: `w13@${DEMO_DOMAIN}`, name: "Дарья Белова",      phone: "+7 916 100-13-13", address: "м. Багратионовская", about: "Бариста 2 года, спешелти-кофейни. Латте-арт, альтернатива.",                      positions: ["Бариста"],                                  minPayment: 3900 },
  { email: `w14@${DEMO_DOMAIN}`, name: "Тимур Абдуллаев",   phone: "+7 916 100-14-14", address: "м. Динамо",        about: "Повар на банкетах, до 300 гостей. Работаю по стандартам HACCP.",                    positions: ["Повар (линейный)", "Менеджер смены"],       minPayment: 6000 },
  { email: `w15@${DEMO_DOMAIN}`, name: "Марина Филатова",   phone: "+7 916 100-15-15", address: "м. Электрозаводская", about: "Прачечная и хозблок в отеле 3*, 3 года. Аккуратность и скорость.",                positions: ["Прачечная", "Горничная"],                   minPayment: 3400 },
  { email: `w16@${DEMO_DOMAIN}`, name: "Кирилл Логинов",    phone: "+7 916 100-16-16", address: "м. Новослободская", about: "Швейцар/посыльный в отеле 5*, презентабельный вид, английский A2.",                positions: ["Швейцар/Посыльный", "Технический персонал"], minPayment: 3800 },
  { email: `w17@${DEMO_DOMAIN}`, name: "Екатерина Жукова",  phone: "+7 916 100-17-17", address: "м. Академическая", about: "Администратор ресепшн, Opera PMS, Bnovo. Опыт 4 года.",                             positions: ["Ресепшн/Администратор", "Менеджер смены"],  minPayment: 5500 },
  { email: `w18@${DEMO_DOMAIN}`, name: "Артём Соловьёв",    phone: "+7 916 100-18-18", address: "м. Бауманская",    about: "Официант банкетов и фуршетов, опыт 2 года. Есть чёрный низ / белый верх.",          positions: ["Официант", "Рунер"],                        minPayment: 3600 },
  { email: `w19@${DEMO_DOMAIN}`, name: "Лилия Ахметова",    phone: "+7 916 100-19-19", address: "м. Отрадное",      about: "Кухонный работник, заготовки, посудомоечная зона. Медкнижка есть.",                 positions: ["Кухонный работник", "Прачечная"],           minPayment: 3200 },
  { email: `w20@${DEMO_DOMAIN}`, name: "Владислав Титов",   phone: "+7 916 100-20-20", address: "м. Войковская",    about: "Менеджер смены в сетевом общепите, 3 года. Закрываю кассу и график.",               positions: ["Менеджер смены", "Официант"],               minPayment: 6000 },
];
