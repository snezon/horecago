...
const WORKERS = [
  ...
  { email: `w4@${DEMO_DOMAIN}`,  name: "Дмитрий Волков",    phone: "+7 916 100-04-04", metro: "Парк культуры", about: "Официант 3 года, рестораны a la carte. Беру вечерние смены.",                       positions: ["Официант", "Рунер"],                        minPayment: 3500 },
  ...
  { email: `w10@${DEMO_DOMAIN}`, name: "Игорь Савельев",    phone: "+7 916 100-10-10", metro: "Автозаводская", about: "Универсал: рунер, кухонный работник, разгрузка. Без опыта не боюсь.",               positions: ["Рунер", "Кухонный работник"],               minPayment: 3000 },
  ...
  { email: `w18@${DEMO_DOMAIN}`, name: "Артём Соловьёв",    phone: "+7 916 100-18-18", metro: "Бауманская",    about: "Официант банкетов и фуршетов, опыт 2 года. Есть чёрный низ / белый верх.",          positions: ["Официант", "Рунер"],                        minPayment: 3600 },
